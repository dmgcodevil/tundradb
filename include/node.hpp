...
class NodeManager {
 public:
  ...
  void set_all_id_counters(const std::unordered_map<std::string, int64_t>& counters) {
 ...
 private:
  ...
  std::unordered_map<std::string, std::unordered_map<int64_t, std::shared_ptr<Node>>> nodes_;
